...
#     'activations': ['relu', 'relu', 'relu']
# }
# diabetes_gan = GAN(discriminator_network_params, generator_network_params, epochs=3500)
...
# }
#
# german_gan = GAN(discriminator_network_params, generator_network_params, dummy_fields_indices=[i for i in range(3, 71)])
